...
namespace Cocoon.Tests
{
    ...
    public class SQLServerEcommerceTest : RegressionTest
    {
        ...
        public override void runTests()
        {
            ...
            //GetScalar
            performTest("GenerateClassFromTable", "", () => { return !string.IsNullOrEmpty(db.GenerateClassFromTable("Order")); });
            ...
            //Insert
            performTest("Insert", "", () => { return db.Insert<TestTable>(new TestTable() { Name = "asd" }).Prim2 != null; });
        ...
        public override void runBenchmark(uint iterations)
        {
            ...
            performBenchmark("Classic SQL Select Single", iterations, () =>
            {
                ...
                using (var da = new SqlDataAdapter(cmd))
                {
                    ...
                    //set sql
                    cmd.CommandText = string.Format("select * from Order where OrderID = {0}", 2);
